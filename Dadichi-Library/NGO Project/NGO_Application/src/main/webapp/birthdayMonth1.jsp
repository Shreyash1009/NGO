...
try {
	...
	pw.print("<tr><td colspan='4'><b>या महिन्यात वाढदिवस:</b></td></tr>");
	while (rs.next()) {
 ...
 pw.print("</td></tr>");
	...
	pw.print("<tr><td colspan='4'><b>मागील महिन्यातील वाढदिवस:</b></td></tr>");
 ...
 hasPreviousMonthBirthdays = true;
	...
	if (!hasCurrentMonthBirthdays) {
		pw.print("<tr><td>");
		pw.print("चालू महिन्यात कोणतेही वाढदिवस नाही<br>");
		pw.print("</td></tr>");
	}
	if (!hasPreviousMonthBirthdays) {
		pw.print("<tr><td>");
		pw.print("मागील महिन्यात कोणतेही वाढदिवस नाही<br>");
		pw.print("</td></tr>");
}
} catch (Exception e) {
